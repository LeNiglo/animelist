...
/*!
 * Generated using the Bootstrap Customizer (http://getbootstrap.com/customize/?id=3d8904b69a22280befce)
 * Config saved to config.json and https://gist.github.com/3d8904b69a22280befce
 */
...
+function (t) {
    ...
    o.VERSION = "3.3.0", o.DEFAULTS = {loadingText: "loading..."}, o.prototype.setState = function (e) {
    ...
    r.VERSION = "3.3.0", r.prototype.toggle = function (i) {
        var n = t(this);
        ...
        if (/(38|40|27|32)/.test(e.which)) {
            ...
            if (e.preventDefault(), e.stopPropagation(), !i.is(".disabled, :disabled")) {
                ...
                if (!r && 27 != e.which || r && 27 == e.which)return 27 == e.which && n.find(s).trigger("focus"), i.trigger("click");
    ...
    function e(e) {
        return this.each(function () {
            var i = t(this), n = i.data("bs.tooltip"), s = "object" == typeof e && e, r = s && s.selector;
    ...
    o.VERSION = "3.3.0", o.TRANSITION_DURATION = 150, o.DEFAULTS = {
        animation: !0,
        placement: "top",
        selector: !1,
        ...
        if (this.hasContent() && this.enabled) {
            ...
            var p = this.getPosition(), d = s[0].offsetWidth, c = s[0].offsetHeight;
            if (h) {
                var f = a, u = this.options.container ? t(this.options.container) : this.$element.parent(), g = this.getPosition(u);
                a = "bottom" == a && p.bottom + c > g.bottom ? "top" : "top" == a && p.top - c < g.top ? "bottom" : "right" == a && p.right + d > g.width ? "left" : "left" == a && p.left - d < g.left ? "right" : a, s.removeClass(f).addClass(a)
            }
            var v = this.getCalculatedOffset(a, p, d, c);
            this.applyPlacement(v, a);
            var m = function () {
                var t = n.hoverState;
                n.$element.trigger("shown.bs." + n.type), n.hoverState = null, "out" == t && n.leave(n)
            };
            t.support.transition && this.$tip.hasClass("fade") ? s.one("bsTransitionEnd", m).emulateTransitionEnd(o.TRANSITION_DURATION) : m()
        }
        ...
        var d = /top|bottom/.test(o), c = d ? 2 * p.left - n + l : 2 * p.top - s + h, f = d ? "offsetWidth" : "offsetHeight";
        ...
        var n = this, s = this.tip(), r = t.Event("hide.bs." + this.type);
    ...
    function e(e) {
        return this.each(function () {
            var i = t(this), n = i.data("bs.popover"), s = "object" == typeof e && e, r = s && s.selector;
    ...
    o.VERSION = "3.3.0", o.DEFAULTS = t.extend({}, t.fn.tooltip.Constructor.DEFAULTS, {
        placement: "right",
        trigger: "click",
        content: "",
    ...
    o.VERSION = "3.3.0", o.TRANSITION_DURATION = 150, o.prototype.show = function () {
        var e = this.element, o = e.closest("ul:not(.dropdown-menu)"), i = e.data("target");
        if (i || (i = e.attr("href"), i = i && i.replace(/.*(?=#[^\s]*$)/, "")), !e.parent("li").hasClass("active")) {
            var n = o.find(".active:last a"), s = t.Event("hide.bs.tab", {relatedTarget: e[0]}), r = t.Event("show.bs.tab", {relatedTarget: n[0]});
        ...
        var r = i.find("> .active"), a = n && t.support.transition && (r.length && r.hasClass("fade") || !!i.find("> .fade").length);
        r.length && a ? r.one("bsTransitionEnd", s).emulateTransitionEnd(o.TRANSITION_DURATION) : s(), r.removeClass("in")
    };
    var i = t.fn.tab;
    ...
    o.VERSION = "3.3.0", o.RESET = "affix affix-top affix-bottom", o.DEFAULTS = {
        offset: 0,
        target: window
        ...
        var a = null == this.affixed, l = a ? n : s.top, h = a ? r : e;
        return null != o && o >= l ? "top" : null != i && l + h >= t - i ? "bottom" : !1
        ...
        if (this.$element.is(":visible")) {
            var e = this.$element.height(), i = this.options.offset, n = i.top, s = i.bottom, r = t("body").height();
    ...
    var i = function (e, o) {
        this.$element = t(e), this.options = t.extend({}, i.DEFAULTS, o), this.$trigger = t(this.options.trigger).filter('[href="#' + e.id + '"], [data-target="#' + e.id + '"]'), this.transitioning = null, this.options.parent ? this.$parent = this.getParent() : this.addAriaAndCollapsedClass(this.$element, this.$trigger), this.options.toggle && this.toggle()
    };
